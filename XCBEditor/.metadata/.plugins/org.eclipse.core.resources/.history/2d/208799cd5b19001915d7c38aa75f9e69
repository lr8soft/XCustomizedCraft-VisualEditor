			...
			for(int i=0;i<value.SEStep.length;i++) {
				...
				switch(temp) {
					...
					case "SD":
						...
						break;
					case "PE":
						stepShow.addElement("药水效果XCB编号"+value.SERuntime[i]+"，总时间"+value.SEDamage[i]);
						break;
				}
			}
			setupContentTree();
