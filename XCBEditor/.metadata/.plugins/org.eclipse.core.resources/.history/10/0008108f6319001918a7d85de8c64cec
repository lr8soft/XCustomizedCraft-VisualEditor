...
public class XCBAbout {
	String lisence="  感谢您选择XCustomizedCraft VisualEditor，XCustomizedCraft VisualEditor隶属于XCustomizedCraft系列下可视化编辑软件，\r\n" + 
			...
			" 版权所有 © 2012-2019，LT_lrsoft 保留所有权利。 \r\n" + 
			" 协议发布时间：2014年08月19日\r\n" + 
			" 2012 ~ 2019 First-Logical Technology Studio,LT_lrsoft. All rights reserved.";
	...
	private void initialize() {
		...
		JLabel lblCopyrightByLtlrsoft = new JLabel("CopyRight by LT_lrsoft,2014~2019");
